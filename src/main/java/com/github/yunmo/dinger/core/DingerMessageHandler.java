...
import com.github.yunmo.dinger.core.annatations.Dinger;
import com.github.yunmo.dinger.core.annatations.DingerPhone;
...
import static com.github.yunmo.dinger.constant.DingerConstant.DINGER_PREFIX;
...
public class DingerMessageHandler
    ...
    public Map<String, Object> paramsHandler(Method method, DingerDefinition dingerDefinition, Object[] values) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            com.github.yunmo.dinger.core.annatations.Parameter[] panno =
                    parameter.getDeclaredAnnotationsByType(com.github.yunmo.dinger.core.annatations.Parameter.class);
