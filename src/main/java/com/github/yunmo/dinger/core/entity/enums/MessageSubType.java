...
import com.github.yunmo.dinger.wetalk.entity.WeMarkdown;
import com.github.yunmo.dinger.wetalk.entity.WeNews;
import com.github.yunmo.dinger.wetalk.entity.WeText;
...
import static com.github.yunmo.dinger.constant.DingerConstant.DINGER_COMMA;
import static com.github.yunmo.dinger.core.DingerDefinitionHandler.WETALK_AT_ALL;
import static com.github.yunmo.dinger.core.entity.enums.ExceptionEnum.DINGER_UNSUPPORT_MESSAGE_TYPE_EXCEPTION;
...
public enum MessageSubType {
    ...
    /**
     * INTERACTIVE类型, 只支持 {@link DingerType#BYTETALK}
     */
    INTERACTIVE(false){
        @Override
        public MsgType msgType(DingerType dingerType, DingerRequest request) {
//            content = "<at id=\"all\">所有人</at>" + content;
            if (dingerType == DingerType.BYTETALK) {
                return new ByteInteractive();
            } else {
                throw new DingerException(DINGER_UNSUPPORT_MESSAGE_TYPE_EXCEPTION, dingerType, this.name());
            }
        }
