...
import com.github.yunmo.dinger.core.DingerRobot;
import com.github.yunmo.dinger.core.entity.DingerProperties;
import com.github.yunmo.dinger.core.session.DingerSessionFactory;
import com.github.yunmo.dinger.core.spring.DingerSessionFactoryBean;
...
public class DingerAutoConfiguration implements InitializingBean {
    ...
    public DingerSessionFactory dingerSessionFactory() throws Exception {
        ...
        factory.setConfiguration(
                com.github.yunmo.dinger.core.session.Configuration.of(properties, dingerRobot)
        );
