 ...
 */
package com.github.yunmo.dinger.config;

import com.github.yunmo.dinger.multi.MultiDingerAlgorithmInjectRegister;
import com.github.yunmo.dinger.multi.MultiDingerHandlerRegister;
import com.github.yunmo.dinger.support.*;
import com.github.yunmo.dinger.support.sign.DingTalkSignAlgorithm;
import com.github.yunmo.dinger.support.sign.DingerSignAlgorithm;
...
import static com.github.yunmo.dinger.constant.DingerConstant.MARKDOWN_MESSAGE;
import static com.github.yunmo.dinger.constant.DingerConstant.TEXT_MESSAGE;
...
public class BeanConfiguration {
    ...
    /**
     * 通过spring实例化handler实例
     *
     * @author ZhangYiHao
     * @date 2023/4/13 16:22
     */
    @Bean
    public static MultiDingerHandlerRegister multiDingerHandlerRegister() {
        return new MultiDingerHandlerRegister();
    }
